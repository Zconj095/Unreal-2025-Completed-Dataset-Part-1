...
#include "ChakraNaturalEnergyComponent.generated.h"
...
class PEKBGGAP_API UChakraNaturalEnergyComponent : public UActorComponent
{
    GENERATED_BODY()

public:
    UChakraNaturalEnergyComponent();
    ...
    void ApplyNaturalEnergyToChakras();

    UFUNCTION(BlueprintCallable, Category="Chakra")
    void ApplyNaturalEnergyToChakra(USceneComponent* ChakraLayer);
