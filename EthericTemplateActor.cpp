#include "EthericTemplateActor.h"

#include "Components/SceneComponent.h"
#include "NiagaraComponent.h"
#include "Particles/ParticleSystemComponent.h"

AEthericTemplateActor::AEthericTemplateActor()
{
    Root = CreateDefaultSubobject<USceneComponent>(TEXT("Root"));
    RootComponent = Root;

#if WITH_EDITOR
    SetActorLabel(TEXT("Etheric Template"));
#endif
}

void AEthericTemplateActor::BeginPlay()
{
    Super::BeginPlay();
    ApplyAuraSettings();
}

void AEthericTemplateActor::ApplyAuraSettings()
{
    if (!AuraLayer)
    {
        return;
...
void AEthericTemplateActor::ApplyToNiagara(UNiagaraComponent* NiagaraComp) const
{
    if (!NiagaraComp)
    {
        return;
...
void AEthericTemplateActor::ApplyToCascade(UParticleSystemComponent* ParticleComp) const
{
    if (!ParticleComp)
    {
        return;
