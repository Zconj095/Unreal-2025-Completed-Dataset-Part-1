#include "ChakraEarnedEnergyComponent.h"

#include "Components/SceneComponent.h"
#include "Particles/ParticleSystemComponent.h"
#include "NiagaraComponent.h"

UChakraEarnedEnergyComponent::UChakraEarnedEnergyComponent()
{
    PrimaryComponentTick.bCanEverTick = false;
}

void UChakraEarnedEnergyComponent::BeginPlay()
{
    Super::BeginPlay();
    ApplyEarnedEnergyToChakras();
}

TArray<USceneComponent*> UChakraEarnedEnergyComponent::GetAllChakras() const
{
...
void UChakraEarnedEnergyComponent::ApplyEarnedEnergyToChakras()
{
    for (USceneComponent* Layer : GetAllChakras())
    {
        ApplyEarnedEnergyToChakra(Layer);
    }
}

void UChakraEarnedEnergyComponent::ApplyEarnedEnergyToChakra(USceneComponent* ChakraLayer)
{
    if (!ChakraLayer)
    {
        return;
...
void UChakraEarnedEnergyComponent::ApplyToNiagara(UNiagaraComponent* NiagaraComp) const
{
    if (!NiagaraComp)
    {
        return;
...
void UChakraEarnedEnergyComponent::ApplyToCascade(UParticleSystemComponent* ParticleComp) const
{
    if (!ParticleComp)
    {
        return;
