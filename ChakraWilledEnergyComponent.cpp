#include "ChakraWilledEnergyComponent.h"

#include "Components/SceneComponent.h"
#include "Particles/ParticleSystemComponent.h"
#include "NiagaraComponent.h"

UChakraWilledEnergyComponent::UChakraWilledEnergyComponent()
{
    PrimaryComponentTick.bCanEverTick = false;
}

void UChakraWilledEnergyComponent::BeginPlay()
{
    Super::BeginPlay();
    ApplyWilledEnergyToChakras();
}

TArray<USceneComponent*> UChakraWilledEnergyComponent::GetAllChakras() const
{
...
void UChakraWilledEnergyComponent::ApplyWilledEnergyToChakras()
{
    for (USceneComponent* Layer : GetAllChakras())
    {
        ApplyWilledEnergyToChakra(Layer);
    }
}

void UChakraWilledEnergyComponent::ApplyWilledEnergyToChakra(USceneComponent* ChakraLayer)
{
    if (!ChakraLayer)
    {
        return;
...
void UChakraWilledEnergyComponent::ApplyToNiagara(UNiagaraComponent* NiagaraComp) const
{
    if (!NiagaraComp)
    {
        return;
...
void UChakraWilledEnergyComponent::ApplyToCascade(UParticleSystemComponent* ParticleComp) const
{
    if (!ParticleComp)
    {
        return;
