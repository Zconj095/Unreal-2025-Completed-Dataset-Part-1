...
#include "ChakraForcedEnergyComponent.generated.h"
...
class PEKBGGAP_API UChakraForcedEnergyComponent : public UActorComponent
{
    GENERATED_BODY()

public:
    UChakraForcedEnergyComponent();
    ...
    void ApplyForcedEnergyToChakras();

    UFUNCTION(BlueprintCallable, Category="Chakra")
    void ApplyForcedEnergyToChakra(USceneComponent* ChakraLayer);
