...
#include "EthericTemplateActor.generated.h"
...
class PEKBGGAP_API AEthericTemplateActor : public AActor
{
    GENERATED_BODY()

public:
    AEthericTemplateActor();
    ...
    FLinearColor AuraColor = FLinearColor(0.7f, 0.7f, 1.f, 1.f);
