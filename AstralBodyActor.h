...
#include "AstralBodyActor.generated.h"
...
class PEKBGGAP_API AAstralBodyActor : public AActor
{
    GENERATED_BODY()
...
public:
    ...
    // The visual FX component to configure (Niagara or Cascade)
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Aura")
    USceneComponent* AuraLayer = nullptr;

    // Prefab parameters (defaults mirror Unity YAML)
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="Aura|Params")
    FLinearColor AuraColor = FLinearColor(0.6f, 1.f, 0.6f, 1.f);
