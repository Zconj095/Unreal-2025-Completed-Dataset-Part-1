...
#include "MentalBodyActor.generated.h"
...
class PEKBGGAP_API AMentalBodyActor : public AActor
{
    GENERATED_BODY()
...
public:
    ...
    FLinearColor AuraColor = FLinearColor(1.f, 1.f, 0.6f, 1.f);
