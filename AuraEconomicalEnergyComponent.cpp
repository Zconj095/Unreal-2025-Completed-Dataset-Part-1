#include "AuraEconomicalEnergyComponent.h"

#include "Components/SceneComponent.h"
#include "Particles/ParticleSystemComponent.h"
#include "NiagaraComponent.h"

UAuraEconomicalEnergyComponent::UAuraEconomicalEnergyComponent()
{
    PrimaryComponentTick.bCanEverTick = false;
}

void UAuraEconomicalEnergyComponent::BeginPlay()
{
    Super::BeginPlay();
    ApplyContentAura();
}

TArray<USceneComponent*> UAuraEconomicalEnergyComponent::GetAllLayers() const
{
...
void UAuraEconomicalEnergyComponent::ApplyContentAura()
{
    for (USceneComponent* Layer : GetAllLayers())
    {
        ApplyEconomicalEnergyToAura(Layer);
    }
}

void UAuraEconomicalEnergyComponent::ApplyEconomicalEnergyToAura(USceneComponent* AuraLayer)
{
    if (!AuraLayer)
    {
        return;
...
void UAuraEconomicalEnergyComponent::ApplyToNiagara(UNiagaraComponent* NiagaraComp) const
{
    if (!NiagaraComp)
    {
        return;
...
void UAuraEconomicalEnergyComponent::ApplyToCascade(UParticleSystemComponent* ParticleComp) const
{
    if (!ParticleComp)
    {
        return;
