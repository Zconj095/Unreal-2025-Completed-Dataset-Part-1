...
#include "ChakraBorrowedEnergyComponent.generated.h"
...
class PEKBGGAP_API UChakraBorrowedEnergyComponent : public UActorComponent
{
    GENERATED_BODY()

public:
    UChakraBorrowedEnergyComponent();
    ...
    void ApplyBorrowedEnergyToChakras();

    UFUNCTION(BlueprintCallable, Category="Chakra")
    void ApplyBorrowedEnergyToChakra(USceneComponent* ChakraLayer);
