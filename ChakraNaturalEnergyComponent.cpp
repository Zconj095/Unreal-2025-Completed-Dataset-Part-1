#include "ChakraNaturalEnergyComponent.h"

#include "Components/SceneComponent.h"
#include "Particles/ParticleSystemComponent.h"
#include "NiagaraComponent.h"

UChakraNaturalEnergyComponent::UChakraNaturalEnergyComponent()
{
    PrimaryComponentTick.bCanEverTick = false;
}

void UChakraNaturalEnergyComponent::BeginPlay()
{
    Super::BeginPlay();
    ApplyNaturalEnergyToChakras();
}

TArray<USceneComponent*> UChakraNaturalEnergyComponent::GetAllChakras() const
{
...
void UChakraNaturalEnergyComponent::ApplyNaturalEnergyToChakras()
{
    for (USceneComponent* Layer : GetAllChakras())
    {
        ApplyNaturalEnergyToChakra(Layer);
    }
}

void UChakraNaturalEnergyComponent::ApplyNaturalEnergyToChakra(USceneComponent* ChakraLayer)
{
    if (!ChakraLayer)
    {
        return;
...
void UChakraNaturalEnergyComponent::ApplyToNiagara(UNiagaraComponent* NiagaraComp) const
{
    if (!NiagaraComp)
    {
        return;
...
void UChakraNaturalEnergyComponent::ApplyToCascade(UParticleSystemComponent* ParticleComp) const
{
    if (!ParticleComp)
    {
        return;
