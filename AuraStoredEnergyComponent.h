...
#include "AuraStoredEnergyComponent.generated.h"
...
class PEKBGGAP_API UAuraStoredEnergyComponent : public UActorComponent
{
    GENERATED_BODY()

public:
    UAuraStoredEnergyComponent();
    ...
    // Defaults for stored energy (slow, medium size, long life, steady)
    ...
    UFUNCTION(BlueprintCallable, Category="Aura")
    void ApplyStoredEnergyToAura(USceneComponent* AuraLayer);
