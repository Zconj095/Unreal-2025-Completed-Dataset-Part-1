...
#include "CausalBodyActor.generated.h"
...
class PEKBGGAP_API ACausalBodyActor : public AActor
{
    GENERATED_BODY()
...
public:
    ...
    // FX layer to configure (Niagara or Cascade component)
    ...
    FLinearColor AuraColor = FLinearColor(1.f, 1.f, 1.f, 1.f);
